...
Сейчас: Только заглушки и интерфейсы
Нужно:
- Разработать полноценные классы узлов AST
...
1. **Первый этап: Базовая структура AST**
   - Создать абстрактный базовый класс Node для всех узлов AST
   - Реализовать узлы для литералов (числа, строки, даты, булевы значения)
   - Добавить узлы для переменных и идентификаторов
   - Реализовать узлы для простых выражений
